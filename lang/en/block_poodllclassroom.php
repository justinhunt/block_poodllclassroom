...
$string['moodlesubs_none']='You do not have any current Poodll for Moodle subscriptions. Click the Add Subscription button to add one.';
...
$string['ltisubs_none']='You do not have any current Poodll for Platforms(LTI) subscriptions. Click the Add Subscription button to add one.';
$string['classroomsubs']='Poodll Classroom Subscription Details';
$string['classroomsubs_none']='You do not have any current Poodll Classroom subscriptions. Click the Add Subscription button to add one.';
...
$string['myschooldetails'] = "School Details";
$string['mypoodllaccount'] = "Poodll Account";
