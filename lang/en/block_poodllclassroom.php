...
$string['poodllclassroom:addinstance'] = 'Add a Poodll Net Admin block';
$string['poodllclassroom:myaddinstance'] = 'Add Poodll Net Admin block to my moodle';
$string['poodllclassroom:managesite'] = 'Manage poodll net site';
$string['pluginname'] = 'Poodll Net Admin';
...
$string['newblock_dosomething_task']=  'Poodll Net Admin dosomething task';
...
$string['privacy:metadata'] = 'The Poodll Net Admin block does not store any user data.';
