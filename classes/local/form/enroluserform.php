...
class enroluserform extends \moodleform {
    ...
    public function definition_after_data() {
        ...
        $mform->addElement('html', '
              ...
              <td id="buttonscell">
                      <input name="add" id="add" type="submit" value="&nbsp;<<&nbsp;'. get_string('enrol', 'block_iomad_company_admin') .
            '" title="Enrol" /></br>
                      <input name="addall" id="addall" type="submit" value="&nbsp;<<&nbsp;'. get_string('enrolall', 'block_iomad_company_admin') .
            '" title="Enrolall" /></br>
